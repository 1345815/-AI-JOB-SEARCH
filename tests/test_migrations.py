...
class MigrationTests(unittest.TestCase):
    ...
    def test_migrate_applies_and_records(self):
        ...
        self.assertEqual(done, ["001"])
        row = self.conn.execute("SELECT * FROM schema_migrations").fetchone()
    ...
    def test_status_marks_applied(self):
        ...
        self.assertTrue(status[0][2])  # (version, name, applied)
