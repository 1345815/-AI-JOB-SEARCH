...
- **Path A (documents folder):** Add your CV, LinkedIn export, diplomas, proof documents (internship certificates, awards, etc.), or past applications under `documents/`. Claude reads and cross-references them before proposing profile updates. This is best when you have several source files.
