...
### 1d. documents/references/（其他证明材料）
Read all files in `documents/references/`. These are proof documents (internship certificates, awards, competition certificates, skills certificates). Extract:
- Competency language used in the documents (what skills or qualities they mention)
...
- Proof-document language (already phrased as competency — just record it)
...
**Soft / Behavioral** (leadership, communication, collaboration signals from proof documents and project descriptions)  

For each competency, record:
- The competency name
- The source item it came from (e.g. "Coursera — Deep Learning Specialisation", "GitHub — repo-name", "Internship certificate — Tencent 2025")
...
**BEHAVIORAL SIGNALS**
Source: [Proof document — Type / LinkedIn About / Project leadership]
  + [Signal 1]
  ...
...
- Always label inferred behavioral additions: *[Inferred from proof document — Type / review before relying on this]*
