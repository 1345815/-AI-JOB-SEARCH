...
**Worked example:** a candidate whose Languages table lists Chinese (Native) and English (CET-4, 512). A posting requiring "fluent Japanese" → **FAIL**, Japanese isn't declared at all. A posting requiring "fluent English" → **FLAG**, English is declared but "fluent" plausibly exceeds CET-4 level — score and draft the application, but tell the candidate this posting's bar may be a stretch and let them decide. A posting requiring "basic English" or unspecified English → **PASS**, CET-4 clears a "basic" bar cleanly.

## 校招/社招 Gate — run before scoring

马育琪是2027届应届生，只接受校招/管培生岗位。

| Posting wording | Verdict |
|---|---|
| 明确标注"校招""应届生""管培生""秋招""春招" | **PASS** |
| 标注"社招"或要求2年以上工作经验 | **FAIL — hard stop.** |
| 未明确标注校招/社招 | **PROCEED, but mark unverified.** 评估时标记为"招聘类型未知，需确认"。 |
...
**Strong match areas:** AI应用（LLM/Prompt工程）、Python数据分析、产品原型设计、游戏系统拆解、内容创作与运营
**Moderate match areas:** Web/小程序开发、数据驱动决策、结构化沟通
**Weak match areas:** 大规模系统开发、团队管理、高级英语沟通
...
**Strong:** AI产品从0到1落地、游戏推广与获客链路、游戏系统拆解、独立产品开发
**Moderate:** 用户运营与沟通（猿辅导经验可迁移）、内容运营与变现
**Entry-level:** 大厂正式实习经验、大规模团队协作
...
**Red flags to research:** 流程繁琐的国企文化、微观管理、不允许试错的环境、缺乏创新驱动的团队。Check reviews, media coverage, LinkedIn connections, and network contacts for insider perspective.

### 4. Location & Logistics (Pass/Fail + Notes)
- 全国范围均可：PASS
- 一线城市（北京/上海/深圳/广州/杭州）：PASS（优先）
- 郑州及周边：PASS
- 需要出国：FLAG（discuss with user）
...
**Career goals:**
- AI游戏策划方向（LLM/Agent/知识工程），将AI能力产品化落地到游戏体验
- AI产品运营方向（商业化/营销），用AI驱动产品增长与商业化
- 持续拓展AI技术实践能力，在快节奏高挑战环境中成长

**Motivation filter:** Evaluate not just whether you *can* do the tasks, but whether the tasks will *energize* you. Consider:
- Tasks that energize: AI产品从0到1落地、游戏玩法设计与系统拆解、数据驱动优化、独立开发与快速迭代
- Tasks that drain: 重复性执行工作、缺乏创新空间的流程性任务、无法度量效果的工作
- Non-task factors: 快节奏创新文化、目标导向管理、跨团队协作机会

**Life situation alignment:** Consider personal constraints:
- **Security**: 应届生校招，暂无薪酬硬性期望，优先看成长机会
- **Flexibility**: 2027届在校生，可接受异地实习/工作
- **Professional development**: AI技术与产品能力的持续提升
