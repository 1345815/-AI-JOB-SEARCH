...
>
> - **Template skeleton:** `templates/cover_letters/china-student/template.tex` - use this as the structural reference instead of the stock template
> - **Manifest:** `templates/cover_letters/china-student/TEMPLATE.md` - read this for style rules and known pitfalls before drafting
> - **Source extension:** `.tex`
> - **Compile command:** `cd cover_letters && xelatex -interaction=nonstopmode <file>.tex`
> - **Fonts:** Fandol CJK fonts (installed with ctex package)
> - **Page limit:** exactly 1 page(s)
> - **Output file:** `cover_letters/cover_<company>_<role>.tex`; copy any class/package/font files the template needs into the output directory, or reference them by relative path
<!-- END ACTIVE-TEMPLATE -->
